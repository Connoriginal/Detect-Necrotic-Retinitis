...
def main():
    ...
    for epoch in range(args['epochs']):
        ...
        plotter.scalar_plot('loss', 'train', epoch, train_loss)
        plotter.scalar_plot('loss', 'valid', epoch, valid_loss)
        plotter.overlap_plot('loss',{'train': train_loss, 'valid': valid_loss}, epoch)
        plotter.scalar_plot('roc_auc_score', 'train', epoch, train_roc_auc_score)
        plotter.scalar_plot('roc_auc_score', 'valid', epoch, valid_roc_auc_score)
