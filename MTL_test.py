...
def main():
    ...
    parser.add_argument('--load_model_path', type=str, default='./model/multiTask/smote_24.pth', help='load model path')
    ...
    df.to_excel('./result/multiTask/smote_24.xlsx')
    ...
    plt.savefig('./result/multiTask/smote_24_ARN.png')
    ...
    plt.title('ROC Curve')
    plt.legend(loc="lower right")
    plt.savefig('./result/multiTask/smote_24_CMV.png')
