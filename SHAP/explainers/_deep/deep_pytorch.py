...
class PyTorchDeep(Explainer):
    ...
    def __init__(self, model, data, model_name = 'ADMTL'):
        ...
        with torch.no_grad():
            if self.model_name == 'ADMTL':
                ...
                out1, out2, adversarial_out, (a_shared, a_private_1, a_private_2) = model(*data)
...
op_handler['GradiantReverseLayer'] = passthrough
